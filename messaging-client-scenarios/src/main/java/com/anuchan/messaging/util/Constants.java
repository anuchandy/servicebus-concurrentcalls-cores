...
public class Constants {
    ...
    public static final String AZURE_SERVICEBUS_SCENARIO = "AZURE_SERVICEBUS_SCENARIO";
    public static final String AZURE_SERVICEBUS_CONNECTION_STRING = "AZURE_SERVICEBUS_CONNECTION_STRING";
    public static final String AZURE_SERVICEBUS_TOPIC_SUBSCRIPTION_ENTRIES = "AZURE_SERVICEBUS_TOPIC_SUBSCRIPTION_ENTRIES";
